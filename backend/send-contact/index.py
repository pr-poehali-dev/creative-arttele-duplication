...
ROUTERS_BLOCK = (
    ...
    "Mesh-системы (покрыть весь дом + двор без мёртвых зон):\n"
    "• Keenetic Voyager Pro (2-pack) — ~18000 ₽. Wi-Fi 6, до 400 м², лёгкая настройка.\n"
    "• TP-Link Deco X60 (3 шт) — ~22000 ₽. Покрытие до 650 м², включая двор.\n"
    "• TP-Link Deco X95 (3 шт) — ~35000 ₽. Wi-Fi 6E, топ для большого коттеджа.\n"
    "• Asus ZenWiFi XT9 (2-pack) — ~25000 ₽. Wi-Fi 6, стабильный roaming, прокачанный AiMesh.\n"
    "Ретрансляторы / усилители сигнала (если уже есть роутер, надо добить угол):\n"
    "• TP-Link RE550 — ~3500 ₽. AC1900, простой повторитель Wi-Fi 5.\n"
    "• TP-Link RE605X — ~4500 ₽. Wi-Fi 6, подходит современным роутерам.\n"
    "• Keenetic Buddy 5 (KN-3311) — ~3800 ₽. Работает в связке с любым Keenetic, держит бесшовный Wi-Fi.\n"
    "Внешние антенны / точки доступа для двора и построек:\n"
    "• Ubiquiti UniFi AC Mesh — ~11000 ₽. Всепогодная точка доступа, до 200 м открытой площадки.\n"
    "• MikroTik wAP ac — ~8500 ₽. Уличный, работает в мороз, ставится на стену/столб.\n"
    "• TP-Link EAP225-Outdoor — ~9000 ₽. Всепогодная точка, покрытие участка/беседки/гаража.\n"
    ...
    "• 100–200 м² или 2 этажа — ставь Mesh из 2 точек (Voyager Pro / Deco X60).\n"
    "• 200+ м² или 3 этажа / двор — Mesh из 3 точек + уличная антенна для беседки/гаража.\n"
    "• Если в доме много умной техники (камеры, датчики, Алиса) — выбирай Wi-Fi 6 и 20+ устройств.\n"
    "• Если нужен интернет в бане/гараже/беседке — предложи уличную точку (UniFi/MikroTik/TP-Link EAP).\n"
    "Спрашивай: площадь, количество этажей, нужен ли Wi-Fi во дворе/хозпостройках, "
    "сколько умных устройств (камеры, ТВ, колонки), бюджет.\n"
