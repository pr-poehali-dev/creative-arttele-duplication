...
ROUTERS_BLOCK = (
    ...
    "Как советовать: спрашивай 1) площадь/количество комнат, 2) тариф (до Мбит/с), "
    "3) сколько устройств одновременно, 4) бюджет. Подбирай тот, что НЕ БУДЕТ узким горлышком тарифа. "
