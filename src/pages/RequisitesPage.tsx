    ...
    <div className="min-h-screen mesh-bg noise font-sans text-white">
      ...
      <div className="pt-28 pb-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div
            className="rounded-2xl p-5 border border-white/5 flex items-start gap-3"
            style={{ background: "rgba(255,255,255,0.03)" }}
          >
            <Icon name="Info" size={18} className="shrink-0 mt-0.5" style={{ color: "var(--neon-blue)" }} />
            <div className="text-white/50 text-sm leading-relaxed">
              Данные актуальны на {today}. Информация получена из открытых официальных источников:
              ЕГРИП, ФНС России, Роскомнадзор.
            </div>
          </div>
        </div>
      </div>
