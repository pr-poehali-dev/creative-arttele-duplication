...
export const aboutInfo = {
  founded: "2012",
  description:
    "АртТелеком Юг — один из крупнейших интернет-провайдеров юга России. Мы строим оптоволоконные сети, предоставляем гигабитный интернет, цифровое ТВ и IP-телефонию для дома и бизнеса.",
  mission:
